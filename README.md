...
| `create_sales_invoice` | Draft sales invoice. Optional `trade_secret` (kutse-/ametisaladus). |
...
| `update_sales_invoice` | PATCH sales draft. Optional `trade_secret`; omitted keeps the stored value. |
